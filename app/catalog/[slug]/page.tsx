...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  if (!product) {
    return {
      title: "Product Not Found | ALREADY DEAD",
    };
  }

  return {
    title: `${product.title} | ALREADY DEAD`,
      ...
      <main className="px-4 py-10 text-black md:px-6 md:py-14">
        <section className="mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border-[3px] border-black bg-white p-6 md:p-8">
            <p className="text-xs font-semibold tracking-[0.22em] text-black/60">ALREADY DEAD / PRODUCT</p>
        ...
        <section className="mx-auto mt-10 w-full max-w-6xl">
          <div className="mb-4 flex items-center justify-between gap-3">
            <h2 className="text-2xl font-bold uppercase tracking-tight md:text-3xl">You may also like</h2>
