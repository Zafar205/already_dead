...
export async function sendOrderPaidEmail(input: OrderPaidEmailInput) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto;">
      <h2 style="margin-bottom: 8px;">Already Dead order confirmed</h2>
      ...
      <p style="margin-bottom: 0; color: #333;">Explore more Already Dead merch here:</p>
...
export async function sendOrderReceivedEmail(input: OrderReceivedEmailInput) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto;">
      <h2 style="margin-bottom: 8px;">Already Dead order received</h2>
